...
function squareRoots(a, b, c) {
	let d = 0;
	if (a === 0) {
		// при а = 0, не пользуясь дискриминантом просто сокращаем уравнение 0x²+bx+c=0 -> bx+c=0 -> x=c/-b. Тогда в const x1 и x2 не придется делить на 0 и получать Nan и -inf.
		return [c / -b];
	} else d = b * b - 4 * a * c; // дискриминант
